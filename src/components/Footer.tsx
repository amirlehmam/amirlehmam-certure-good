      ...
      <div className="px-8 md:px-16 pt-16 pb-16 grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10">
        ...
        <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8 lg:pl-12">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li><Link to="/" className="hover:text-[#2D5CF3] transition-colors font-sans">Accueil</Link></li>
              <li><Link to="/formations" className="hover:text-[#2D5CF3] transition-colors font-sans">Nos Formations</Link></li>
              <li><a href="/#equipe" className="hover:text-[#2D5CF3] transition-colors font-sans">Notre équipe</a></li>
          ...
          <div className="space-y-6 hidden sm:block">
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li><a href="https://drive.google.com/file/d/1AbYNyA39ifObir4XwD66UXTkzK_4SUHZ/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white/5 border border-white/10 px-4 py-2 rounded-lg text-xs hover:bg-white/10 transition-all text-white font-bold group">
                Certificat Qualiopi
